...
variable "second_tg_arn" {
    description = "ARN of second listener in LoadBalancer"
    type        = string
...
variable "enable_execute_command" {
  description = "Enable ECS Exec to execute commands in the container"
  type        = bool
  default     = false
}

variable "volume_name" {
  description = "describe a name for the EFS volume"
  type        = string
}

variable "efs_id" {
  description = "Insert the ID of EFS generated"
  type        = string
}
...
variable "read_only" {
  description = "set true or false to make the volume only readable"
  type        = bool
  default     = false
}

variable "matcher" {
  description = "HTTP response codes to use when checking for a healthy response from a target"
  type        = string
}
...
variable "encryption" {
  description = "Transit encryption for EFS volume"
  type        = string
  default     = "DISABLED"
}
