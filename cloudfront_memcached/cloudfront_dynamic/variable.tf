...
variable "ordered_cache_behavior" {
    description = "Set a bunch of values for CloudFront distribution"
    type = map
    default = {}  
}

variable "ordered_cache_behavior_s3" {
    description = "Set a bunch of values for CloudFront distribution"
    type = map
    default = {}  
}
...
variable "origin_lb" {
    description = "Set values for CloudFront distribution origin"
    type = map
    default = {}  
}
